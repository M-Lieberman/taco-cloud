...
public class DesignTacoController {
	...
	public String showDesignForm(Model model) {
		...
		// alternate method of adding filtered attributes
		// model.addAllAttributes(ingredients.stream().collect(Collectors.groupingBy(ingredient->ingredient.getType().toString().toLowerCase())));

		return "design";
	}

	// TODO understand Streams
